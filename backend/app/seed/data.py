...
PACKAGES = [
    (
        ...
        1800,
        [
            "Premium-grade carcass board (BWR/MR)",
            "Premium hardware (Fevicol-grade fittings)",
            "Premium laminate shutter finish",
            "Basic screws & fasteners",
        ],
        "Reliable, premium-grade kitchen build.",
        1,
    ),
    (
        "premium",
        ...
        [
            ...
            "Choice of ultra premium hardware brand (Hettich / Hafle / Ebco)",
            "PU/acrylic shutter finish options",
            "Soft-close fittings",
        ],
        "Ultra premium hardware brand of your choice, upgraded finishes.",
        2,
    ),
    (
        "ultra_premium",
        "Luxury (Acrylic Kitchen)",
        2400,
        [
            "Top-grade board and finishes",
            "Ultra premium hardware brand bundled",
            "Luxury acrylic shutter finish",
            "Premium lighting package",
            "Rolling shutter included",
        ],
        "Fully loaded — luxury acrylic finish, hardware, lighting, and rolling shutters bundled in.",
        3,
    ),
]
